    ...
    public class ResShopPromotion : IUnpackable, tsf4g_csharp_interface
    {
        ...
        public TdrError.ErrorType load(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                int count = 0x10;
                if (this.szOnTimeStr_ByteArray.GetLength(0) < count)
                {
                    this.szOnTimeStr_ByteArray = new byte[LENGTH_szOnTimeStr];
                }
                type = srcBuf.readCString(ref this.szOnTimeStr_ByteArray, count);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                ...
                type = srcBuf.readCString(ref this.szOffTimeStr_ByteArray, num2);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                ...
                type = srcBuf.readUInt32(ref this.dwPrice);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
        ...
        public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                if (dest > this.szOnTimeStr_ByteArray.GetLength(0))
                {
                    if (dest > LENGTH_szOnTimeStr)
                    {
                        return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
                    }
                    this.szOnTimeStr_ByteArray = new byte[dest];
                }
                if (1 > dest)
                {
                    return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_SMALL;
                }
                type = srcBuf.readCString(ref this.szOnTimeStr_ByteArray, (int) dest);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                if (this.szOnTimeStr_ByteArray[((int) dest) - 1] != 0)
                {
                ...
                if (num3 > this.szOffTimeStr_ByteArray.GetLength(0))
                {
                    if (num3 > LENGTH_szOffTimeStr)
                    {
                        return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
                    }
                ...
                type = srcBuf.readCString(ref this.szOffTimeStr_ByteArray, (int) num3);
                if (type == TdrError.ErrorType.TDR_NO_ERROR)
                {
                    if (this.szOffTimeStr_ByteArray[((int) num3) - 1] != 0)
                    {
                        return TdrError.ErrorType.TDR_ERR_STR_LEN_CONFLICT;
                    }

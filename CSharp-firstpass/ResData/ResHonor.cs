namespace ResData
{
    ...
    {
        public ResDT_HonorLevel_Info[] astHonorLevel = new ResDT_HonorLevel_Info[4];
        public static readonly uint BASEVERSION = 1;
        public static readonly uint CURRVERSION = 1;
        public int iID;
        public static readonly uint LENGTH_szDesc = 0x200;
        ...
        public TdrError.ErrorType load(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            type = srcBuf.readInt32(ref this.iID);
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                for (int i = 0; i < 4; i++)
                {
                    type = this.astHonorLevel[i].load(ref srcBuf, cutVer);
                    if (type != TdrError.ErrorType.TDR_NO_ERROR)
                    {
                        return type;
                    }
        ...
        public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                if (type == TdrError.ErrorType.TDR_NO_ERROR)
                {
                    ...
                    for (int i = 0; i < 4; i++)
                    {
                        type = this.astHonorLevel[i].unpack(ref srcBuf, cutVer);
                        if (type != TdrError.ErrorType.TDR_NO_ERROR)
                        {
                            return type;
                        }

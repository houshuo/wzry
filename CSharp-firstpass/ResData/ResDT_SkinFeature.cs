namespace ResData
{
    ...
    public class ResDT_SkinFeature : IUnpackable, tsf4g_csharp_interface
    {
        ...
        public static readonly uint LENGTH_szDesc = 0x40;
        public static readonly uint LENGTH_szIconPath = 0x20;
        ...
        public TdrError.ErrorType load(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            int count = 0x20;
            if (this.szIconPath_ByteArray.GetLength(0) < count)
            {
                this.szIconPath_ByteArray = new byte[LENGTH_szIconPath];
            }
            type = srcBuf.readCString(ref this.szIconPath_ByteArray, count);

    ...
    public class ResSoulLvlUpInfo : IUnpackable, tsf4g_csharp_interface
    {
        ...
        public TdrError.ErrorType load(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                type = srcBuf.readUInt32(ref this.dwKilledExp);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                type = srcBuf.readUInt32(ref this.dwExtraKillExp);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                ...
                type = srcBuf.readUInt16(ref this.wKillGoldCoinInBattle);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                type = srcBuf.readUInt16(ref this.wExtraKillGoldCoinInBattle);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }

namespace ResData
{
    ...
    public class ResAcntPvpExpInfo : IUnpackable, tsf4g_csharp_interface
    {
        ...
        public static readonly uint LENGTH_szTitle = 0x80;
        public static readonly uint LENGTH_szTitleIcon = 0x20;
        public string szTitle = string.Empty;
        public byte[] szTitle_ByteArray = new byte[1];
        public string szTitleIcon = string.Empty;
        public byte[] szTitleIcon_ByteArray = new byte[1];
        ...
        public TdrError.ErrorType load(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                type = srcBuf.readUInt32(ref this.dwNeedExp);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                ...
                {
                    this.szTitleIcon_ByteArray = new byte[LENGTH_szTitleIcon];
                }
                type = srcBuf.readCString(ref this.szTitleIcon_ByteArray, num2);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                type = srcBuf.readUInt32(ref this.dwTotalExpBefore);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
        ...
        public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                if (num3 > this.szTitleIcon_ByteArray.GetLength(0))
                {
                    if (num3 > LENGTH_szTitleIcon)
                    {
                        return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
                    }
                ...
                type = srcBuf.readCString(ref this.szTitleIcon_ByteArray, (int) num3);
                if (type == TdrError.ErrorType.TDR_NO_ERROR)
                {
                    if (this.szTitleIcon_ByteArray[((int) num3) - 1] != 0)
                    {
                        return TdrError.ErrorType.TDR_ERR_STR_LEN_CONFLICT;
                    }

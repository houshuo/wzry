...
public class NcTimerTool
{
    ...
    {
        return (this.m_fLastEngineTime != GetEngineTime());
    }
    ...
    public void Reset(float fElapsedTime)
    {
        ...
        this.m_fLastEngineTime = GetEngineTime() - 1E-06f;
        this.UpdateTimer();
    }
    ...
    private float UpdateTimer()
    {
        if (this.m_bEnable)
        {
            if (this.m_fLastEngineTime != GetEngineTime())
            {
                this.m_fLastTime = this.m_fCurrentTime;
                this.m_fCurrentTime += (GetEngineTime() - this.m_fLastEngineTime) * this.GetTimeScale();
                this.m_fLastEngineTime = GetEngineTime();
                if (this.m_fSmoothTimes != null)
                {

namespace CSProtocol
{
    ...
    {
        public COMDT_COMMONUSEHERO_OF_RANK[] astCommonUseHero = new COMDT_COMMONUSEHERO_OF_RANK[3];
        public byte bAcntLevel;
        public static readonly uint BASEVERSION = 1;
        public byte bScore;
        public static readonly int CLASS_ID = 0x14d;
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            type = srcBuf.readUInt8(ref this.bAcntLevel);
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                uint dest = 0;
                ...
                if (type == TdrError.ErrorType.TDR_NO_ERROR)
                {
                    ...
                    type = srcBuf.readUInt8(ref this.bScore);
                    if (type != TdrError.ErrorType.TDR_NO_ERROR)
                    {
                        return type;
                    }
                    ...
                    for (int i = 0; i < 3; i++)
                    {
                        type = this.astCommonUseHero[i].unpack(ref srcBuf, cutVer);
                        if (type != TdrError.ErrorType.TDR_NO_ERROR)
                        {
                            return type;
                        }

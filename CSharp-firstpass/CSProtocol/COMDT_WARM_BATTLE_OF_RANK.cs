namespace CSProtocol
{
    ...
    public class COMDT_WARM_BATTLE_OF_RANK : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x20c;
        public static readonly uint CURRVERSION = 1;
        public uint dwContinuousLoseCnt;
        public uint dwLastRefreshTime;
        public uint[] TodayCnt = new uint[10];
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                type = destBuf.writeUInt32(this.TodayCnt[i]);
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                type = srcBuf.readUInt32(ref this.TodayCnt[i]);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }

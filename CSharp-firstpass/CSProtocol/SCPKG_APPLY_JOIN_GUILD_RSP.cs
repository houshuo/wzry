namespace CSProtocol
{
    ...
    public class SCPKG_APPLY_JOIN_GUILD_RSP : ProtocolObject
    {
        ...
        public byte bResult;
        public static readonly int CLASS_ID = 0x444;
        public static readonly uint CURRVERSION = 0x84;
        public uint dwApplyTime;
        public COMDT_GUILD_BRIEF_INFO stGuildBriefInfo = ((COMDT_GUILD_BRIEF_INFO) ProtocolObjectPool.Get(COMDT_GUILD_BRIEF_INFO.CLASS_ID));
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                type = destBuf.writeUInt32(this.dwApplyTime);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                type = srcBuf.readUInt32(ref this.dwApplyTime);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }

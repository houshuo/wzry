namespace CSProtocol
{
    ...
    public class CSDT_RANKING_LIST_ITEM_INFO : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x3e4;
        ...
        public COMDT_RANKING_LIST_ITEM_EXTRA_INFO stExtraInfo = ((COMDT_RANKING_LIST_ITEM_EXTRA_INFO) ProtocolObjectPool.Get(COMDT_RANKING_LIST_ITEM_EXTRA_INFO.CLASS_ID));
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                type = destBuf.writeUInt32(this.dwRankScore);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                if (type == TdrError.ErrorType.TDR_NO_ERROR)
                {
                    ...
                    type = srcBuf.readUInt32(ref this.dwRankScore);
                    if (type != TdrError.ErrorType.TDR_NO_ERROR)
                    {
                        return type;
                    }

namespace CSProtocol
{
    ...
    public class COMDT_MATCH_ERR_DETAIL : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0xd8;
        public static readonly uint CURRVERSION = 1;
        public int iErrCode;
        public COMDT_MATCH_ERR_PARAM stErrParam = ((COMDT_MATCH_ERR_PARAM) ProtocolObjectPool.Get(COMDT_MATCH_ERR_PARAM.CLASS_ID));
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                type = this.stErrParam.pack(iErrCode, ref destBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            {
                long iErrCode = this.iErrCode;
                type = this.stErrParam.unpack(iErrCode, ref srcBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }

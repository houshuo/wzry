namespace CSProtocol
{
    ...
    public class CSPKG_PVP_COMMINFO_REPORT : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x47d;
        public static readonly uint CURRVERSION = 1;
        public uint dwDeskId;
        public uint dwDeskSeq;
        public COMDT_MULTI_GAME_PARAM stCommonInfo = ((COMDT_MULTI_GAME_PARAM) ProtocolObjectPool.Get(COMDT_MULTI_GAME_PARAM.CLASS_ID));
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                type = destBuf.writeUInt8(this.bPlayerNum);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                type = srcBuf.readUInt8(ref this.bPlayerNum);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }

namespace CSProtocol
{
    ...
    public class SCPKG_GET_RANKING_ACNT_INFO_RSP : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x3f0;
        public static readonly uint CURRVERSION = 1;
        public int iErrCode;
        public CSDT_ACNT_RANKING_DETAIL stAcntRankingDetail = ((CSDT_ACNT_RANKING_DETAIL) ProtocolObjectPool.Get(CSDT_ACNT_RANKING_DETAIL.CLASS_ID));
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                type = this.stAcntRankingDetail.pack(iErrCode, ref destBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            {
                long iErrCode = this.iErrCode;
                type = this.stAcntRankingDetail.unpack(iErrCode, ref srcBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }

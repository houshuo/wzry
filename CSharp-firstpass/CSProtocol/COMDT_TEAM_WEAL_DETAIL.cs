namespace CSProtocol
{
    ...
    public class COMDT_TEAM_WEAL_DETAIL : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x1f0;
        public static readonly uint CURRVERSION = 1;
        public uint dwWealID;
        public COMDT_TEAM_WEAL_UNION stWealData = ((COMDT_TEAM_WEAL_UNION) ProtocolObjectPool.Get(COMDT_TEAM_WEAL_UNION.CLASS_ID));
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                type = this.stWealData.pack(bWealType, ref destBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                long bWealType = this.bWealType;
                type = this.stWealData.unpack(bWealType, ref srcBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }

namespace CSProtocol
{
    ...
    public class COMDT_TRANS_CONTEXT_OF_FIRE_MEMBER : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x167;
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            {
                type = destBuf.writeUInt64(this.ullOperUid);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                ...
                type = destBuf.writeUInt64(this.ullFireUid);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                ...
                type = destBuf.writeUInt32(this.dwFireGameEntity);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                type = srcBuf.readUInt64(ref this.ullOperUid);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                ...
                type = srcBuf.readUInt64(ref this.ullFireUid);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                ...
                if (type == TdrError.ErrorType.TDR_NO_ERROR)
                {
                    ...
                    type = srcBuf.readUInt32(ref this.dwFireGameEntity);
                    if (type != TdrError.ErrorType.TDR_NO_ERROR)
                    {
                        return type;
                    }

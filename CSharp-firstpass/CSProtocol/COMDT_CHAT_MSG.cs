namespace CSProtocol
{
    ...
    public class COMDT_CHAT_MSG : ProtocolObject
    {
        ...
        public byte bType;
        public static readonly int CLASS_ID = 0x100;
        public static readonly uint CURRVERSION = 1;
        public COMDT_CHAT_MSG_UNION stContent = ((COMDT_CHAT_MSG_UNION) ProtocolObjectPool.Get(COMDT_CHAT_MSG_UNION.CLASS_ID));
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                type = this.stContent.pack(bType, ref destBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            {
                long bType = this.bType;
                type = this.stContent.unpack(bType, ref srcBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }

namespace CSProtocol
{
    ...
    public class COMDT_TRANS_CONTEXT_OF_ADD_RANKPASTSEASONDATA : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x173;
        public static readonly uint CURRVERSION = 0x79;
        public COMDT_RANK_PASTSEASON_FIGHT_RECORD stPastSeasonRecord = ((COMDT_RANK_PASTSEASON_FIGHT_RECORD) ProtocolObjectPool.Get(COMDT_RANK_PASTSEASON_FIGHT_RECORD.CLASS_ID));
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            type = this.stPastSeasonRecord.pack(ref destBuf, cutVer);
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            type = this.stPastSeasonRecord.unpack(ref srcBuf, cutVer);
            if (type != TdrError.ErrorType.TDR_NO_ERROR)
            {
                return type;
            }

namespace CSProtocol
{
    ...
    public class CSPKG_PVP_GAMEDATA_REPORT : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x47e;
        public static readonly uint CURRVERSION = 1;
        public uint dwGameDataLen;
        public sbyte[] szGameData = new sbyte[0x8000];
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            type = destBuf.writeUInt32(this.dwGameDataLen);
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                if (this.szGameData.Length < this.dwGameDataLen)
                {
                    return TdrError.ErrorType.TDR_ERR_VAR_ARRAY_CONFLICT;
                }
                for (int i = 0; i < this.dwGameDataLen; i++)
                {
                    type = destBuf.writeInt8(this.szGameData[i]);
                    if (type != TdrError.ErrorType.TDR_NO_ERROR)
                    {
                        return type;
                    }

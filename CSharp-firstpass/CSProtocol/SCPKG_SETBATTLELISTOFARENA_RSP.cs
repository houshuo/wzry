namespace CSProtocol
{
    ...
    public class SCPKG_SETBATTLELISTOFARENA_RSP : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x486;
        public static readonly uint CURRVERSION = 1;
        public SCDT_SETBATTLELISTOFARENA_RESULT stResult = ((SCDT_SETBATTLELISTOFARENA_RESULT) ProtocolObjectPool.Get(SCDT_SETBATTLELISTOFARENA_RESULT.CLASS_ID));
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                type = this.stResult.pack(bErrCode, ref destBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            {
                long bErrCode = this.bErrCode;
                type = this.stResult.unpack(bErrCode, ref srcBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }

namespace CSProtocol
{
    ...
    public class SCPKG_GUILD_CROSS_DAY_NTF : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x46e;
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            {
                type = destBuf.writeUInt8(this.bBuildingHallLevel);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                type = destBuf.writeUInt32(this.dwGuildActive);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                type = srcBuf.readUInt8(ref this.bBuildingHallLevel);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                type = srcBuf.readUInt32(ref this.dwGuildActive);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }

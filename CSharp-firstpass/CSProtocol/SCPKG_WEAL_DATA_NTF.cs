namespace CSProtocol
{
    ...
    public class SCPKG_WEAL_DATA_NTF : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x4ad;
        ...
        public COMDT_WEAL_POINT_DATA stWealPointData = ((COMDT_WEAL_POINT_DATA) ProtocolObjectPool.Get(COMDT_WEAL_POINT_DATA.CLASS_ID));
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                type = this.stWealPointData.pack(ref destBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                type = this.stWealPointData.unpack(ref srcBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }

namespace CSProtocol
{
    ...
    public class SCPKG_GET_RANKING_LIST_RSP : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x3e8;
        public static readonly uint CURRVERSION = 0x6b;
        public uint dwSubType;
        public int iErrCode;
        public CSDT_RANKING_LIST_DETAIL stRankingListDetail = ((CSDT_RANKING_LIST_DETAIL) ProtocolObjectPool.Get(CSDT_RANKING_LIST_DETAIL.CLASS_ID));
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                type = this.stRankingListDetail.pack(iErrCode, ref destBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                long iErrCode = this.iErrCode;
                type = this.stRankingListDetail.unpack(iErrCode, ref srcBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }

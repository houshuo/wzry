namespace CSProtocol
{
    ...
    public class SCDT_NTF_ERRCODE : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x231;
        ...
        private void select_30_30(long selector)
        {
            if (selector == 30L)
            {
                if (!(this.dataObject is SCDT_NTF_REGISTERERRCODE))
                {
                    if (this.dataObject != null)
                    {
                        this.dataObject.Release();

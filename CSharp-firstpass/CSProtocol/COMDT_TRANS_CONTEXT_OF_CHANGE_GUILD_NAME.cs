namespace CSProtocol
{
    ...
    public class COMDT_TRANS_CONTEXT_OF_CHANGE_GUILD_NAME : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x176;
        public static readonly uint CURRVERSION = 1;
        public uint dwGameEntity;
        public static readonly uint LENGTH_szNewName = 0x20;
        public static readonly uint LENGTH_szOrgName = 0x20;
        public byte[] szNewName = new byte[0x20];
        public byte[] szOrgName = new byte[0x20];

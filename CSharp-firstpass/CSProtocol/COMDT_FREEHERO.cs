namespace CSProtocol
{
    ...
    public class COMDT_FREEHERO : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x75;
        public static readonly uint CURRVERSION = 1;
        public uint dwDeadline;
        public COMDT_FREEHERO_LIST stFreeHeroList = ((COMDT_FREEHERO_LIST) ProtocolObjectPool.Get(COMDT_FREEHERO_LIST.CLASS_ID));
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            {
                type = this.stFreeHeroList.pack(ref destBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                type = this.stFreeHeroList.unpack(ref srcBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }

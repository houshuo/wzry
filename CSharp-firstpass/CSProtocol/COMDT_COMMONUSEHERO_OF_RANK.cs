    ...
    public class COMDT_COMMONUSEHERO_OF_RANK : ProtocolObject
    {
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                type = srcBuf.readInt32(ref this.iHeroStar);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                type = srcBuf.readUInt32(ref this.dwHeroProficiency);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                type = srcBuf.readUInt8(ref this.bHeroProficiencyLv);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }

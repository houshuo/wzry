namespace CSProtocol
{
    ...
    public class CSPKG_UPLOADCLTLOG_NTF : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x52e;
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            type = destBuf.writeUInt32(this.dwLogType);
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                type = destBuf.writeUInt32(this.dwBuffOffset);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                ...
                type = destBuf.writeUInt8(this.bThisLogOver);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                type = destBuf.writeUInt8(this.bAllLogOver);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            type = srcBuf.readUInt32(ref this.dwLogType);
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                type = srcBuf.readUInt32(ref this.dwBuffOffset);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                ...
                type = srcBuf.readUInt8(ref this.bThisLogOver);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                type = srcBuf.readUInt8(ref this.bAllLogOver);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }

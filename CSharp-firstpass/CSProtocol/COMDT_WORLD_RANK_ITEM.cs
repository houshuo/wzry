namespace CSProtocol
{
    ...
    public class COMDT_WORLD_RANK_ITEM : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x1da;
        public static readonly uint CURRVERSION = 0x6b;
        public uint dwRankType;
        public uint dwScore;
        public uint dwSubType;
        public uint dwTimeStamp;
        public COMDT_WORLD_RANK_ACNT stAcntInfo = ((COMDT_WORLD_RANK_ACNT) ProtocolObjectPool.Get(COMDT_WORLD_RANK_ACNT.CLASS_ID));
        public COMDT_RANKING_LIST_ITEM_EXTRA_DETAIL stDetailInfo = ((COMDT_RANKING_LIST_ITEM_EXTRA_DETAIL) ProtocolObjectPool.Get(COMDT_RANKING_LIST_ITEM_EXTRA_DETAIL.CLASS_ID));
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                type = destBuf.writeUInt32(this.dwRankType);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                type = destBuf.writeUInt32(this.dwSubType);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                long dwRankType = this.dwRankType;
                type = this.stDetailInfo.pack(dwRankType, ref destBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                long dwRankType = this.dwRankType;
                type = this.stDetailInfo.unpack(dwRankType, ref srcBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }

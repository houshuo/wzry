namespace CSProtocol
{
    ...
    public class SCPKG_MATCH_RSP : ProtocolObject
    {
        ...
        public byte bResult;
        public static readonly int CLASS_ID = 0x3b9;
        public static readonly uint CURRVERSION = 1;
        public COMDT_MATCH_RESULT stMatchResDetail = ((COMDT_MATCH_RESULT) ProtocolObjectPool.Get(COMDT_MATCH_RESULT.CLASS_ID));
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                type = this.stMatchResDetail.pack(bResult, ref destBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            {
                long bResult = this.bResult;
                type = this.stMatchResDetail.unpack(bResult, ref srcBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }

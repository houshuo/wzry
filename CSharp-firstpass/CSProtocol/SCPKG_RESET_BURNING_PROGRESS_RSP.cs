namespace CSProtocol
{
    ...
    public class SCPKG_RESET_BURNING_PROGRESS_RSP : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x42d;
        public static readonly uint CURRVERSION = 0x8a;
        public int iErrCode;
        public CSDT_BURNING_LEVEL_DETAIL stNewProgress = ((CSDT_BURNING_LEVEL_DETAIL) ProtocolObjectPool.Get(CSDT_BURNING_LEVEL_DETAIL.CLASS_ID));
        ...
        public override TdrError.ErrorType construct()
        {
            ...
            type = this.stNewProgress.construct(iErrCode);
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            {
                long iErrCode = this.iErrCode;
                type = this.stNewProgress.pack(iErrCode, ref destBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            {
                long iErrCode = this.iErrCode;
                type = this.stNewProgress.unpack(iErrCode, ref srcBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }

namespace CSProtocol
{
    ...
    public class COMDT_TRANS_CONTEXT_OF_ONLINECHK : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x150;
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            type = destBuf.writeUInt8(this.bBNextStep);
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                type = destBuf.writeUInt32(this.dwOldGsid);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            type = srcBuf.readUInt8(ref this.bBNextStep);
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                type = srcBuf.readUInt32(ref this.dwOldGsid);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }

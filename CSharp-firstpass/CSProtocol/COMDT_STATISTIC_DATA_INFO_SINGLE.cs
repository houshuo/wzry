namespace CSProtocol
{
    ...
    public class COMDT_STATISTIC_DATA_INFO_SINGLE : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x1c0;
        public static readonly uint CURRVERSION = 12;
        public uint dwDrawSum;
        public uint dwLoseSum;
        public uint dwWinSum;
        public int iGameTypeParam;
        public static readonly uint VERSION_iGameTypeParam = 12;
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            {
                if (VERSION_iGameTypeParam <= cutVer)
                {
                    type = destBuf.writeInt32(this.iGameTypeParam);
                    if (type != TdrError.ErrorType.TDR_NO_ERROR)
                    {
                        return type;
                    }
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                if (VERSION_iGameTypeParam <= cutVer)
                {
                    type = srcBuf.readInt32(ref this.iGameTypeParam);
                    if (type != TdrError.ErrorType.TDR_NO_ERROR)
                    {
                        return type;
                    }

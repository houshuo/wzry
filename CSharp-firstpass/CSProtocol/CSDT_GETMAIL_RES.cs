namespace CSProtocol
{
    ...
    public class CSDT_GETMAIL_RES : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x39c;
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                type = destBuf.writeUInt8(this.bAutoDel);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                ...
                type = destBuf.writeUInt32(this.dwSendTime);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                type = srcBuf.readUInt8(ref this.bAutoDel);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                ...
                if (type == TdrError.ErrorType.TDR_NO_ERROR)
                {
                    ...
                    type = srcBuf.readUInt32(ref this.dwSendTime);
                    if (type != TdrError.ErrorType.TDR_NO_ERROR)
                    {
                        return type;
                    }

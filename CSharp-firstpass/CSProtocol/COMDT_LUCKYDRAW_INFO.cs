namespace CSProtocol
{
    ...
    public class COMDT_LUCKYDRAW_INFO : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x149;
        public static readonly uint CURRVERSION = 0x2f;
        public uint dwCnt;
        public uint dwDrawMask;
        public uint dwLuckyPoint;
        public uint dwReachMask;
        public COMDT_LUCKYDRAW_MISS stNormalMiss = ((COMDT_LUCKYDRAW_MISS) ProtocolObjectPool.Get(COMDT_LUCKYDRAW_MISS.CLASS_ID));
        public COMDT_LUCKYDRAW_MISS stPeriodMiss = ((COMDT_LUCKYDRAW_MISS) ProtocolObjectPool.Get(COMDT_LUCKYDRAW_MISS.CLASS_ID));
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                type = this.stNormalMiss.pack(ref destBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                type = this.stPeriodMiss.pack(ref destBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                type = this.stNormalMiss.unpack(ref srcBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                type = this.stPeriodMiss.unpack(ref srcBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }

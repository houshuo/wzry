namespace CSProtocol
{
    ...
    public class CSPKG_UPDNEWCLIENTBITS_NTF : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x492;
        public static readonly uint CURRVERSION = 1;
        public COMDT_NEWCLIENT_BITS stClientBits = ((COMDT_NEWCLIENT_BITS) ProtocolObjectPool.Get(COMDT_NEWCLIENT_BITS.CLASS_ID));

namespace CSProtocol
{
    ...
    public class SCPKG_ACHIEVEMENT_INFO_NTF : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x4c5;
        public static readonly uint CURRVERSION = 0x29;
        public COMDT_ACHIEVEMENT_INFO stAchievementInfo = ((COMDT_ACHIEVEMENT_INFO) ProtocolObjectPool.Get(COMDT_ACHIEVEMENT_INFO.CLASS_ID));
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            type = this.stAchievementInfo.pack(ref destBuf, cutVer);
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            type = this.stAchievementInfo.unpack(ref srcBuf, cutVer);
            if (type != TdrError.ErrorType.TDR_NO_ERROR)
            {
                return type;
            }

namespace CSProtocol
{
    ...
    public class COMDT_TRANSACTION_MSG_OF_IDIPSENDMAILREQ : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x182;
        public static readonly uint CURRVERSION = 0x53;
        public COMDT_IDIP_MAIL_INFO stIdipMailInfo = ((COMDT_IDIP_MAIL_INFO) ProtocolObjectPool.Get(COMDT_IDIP_MAIL_INFO.CLASS_ID));
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            type = this.stIdipMailInfo.pack(ref destBuf, cutVer);
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            type = this.stIdipMailInfo.unpack(ref srcBuf, cutVer);
            if (type != TdrError.ErrorType.TDR_NO_ERROR)
            {
                return type;
            }

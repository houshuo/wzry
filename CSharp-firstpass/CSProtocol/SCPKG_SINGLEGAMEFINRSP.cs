namespace CSProtocol
{
    ...
    public class SCPKG_SINGLEGAMEFINRSP : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x281;
        public static readonly uint CURRVERSION = 0x71;
        public int iErrCode;
        public COMDT_SETTLE_RESULT_DETAIL stDetail = ((COMDT_SETTLE_RESULT_DETAIL) ProtocolObjectPool.Get(COMDT_SETTLE_RESULT_DETAIL.CLASS_ID));

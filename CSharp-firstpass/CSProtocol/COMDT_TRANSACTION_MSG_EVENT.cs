namespace CSProtocol
{
    ...
    public class COMDT_TRANSACTION_MSG_EVENT : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x192;
        public static readonly uint CURRVERSION = 0x53;
        public int iType;
        public COMDT_TRANSACTION_MSG_DETAIL stDetail = ((COMDT_TRANSACTION_MSG_DETAIL) ProtocolObjectPool.Get(COMDT_TRANSACTION_MSG_DETAIL.CLASS_ID));

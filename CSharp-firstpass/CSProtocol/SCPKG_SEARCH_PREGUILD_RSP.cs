namespace CSProtocol
{
    ...
    public class SCPKG_SEARCH_PREGUILD_RSP : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x457;
        public static readonly uint CURRVERSION = 0x84;
        public COMDT_PREPARE_GUILD_BRIEF_INFO stPreGuildBriefInfo = ((COMDT_PREPARE_GUILD_BRIEF_INFO) ProtocolObjectPool.Get(COMDT_PREPARE_GUILD_BRIEF_INFO.CLASS_ID));
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            {
                type = this.stPreGuildBriefInfo.pack(ref destBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                type = this.stPreGuildBriefInfo.unpack(ref srcBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }

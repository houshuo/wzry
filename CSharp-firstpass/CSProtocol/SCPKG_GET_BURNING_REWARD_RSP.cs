namespace CSProtocol
{
    ...
    public class SCPKG_GET_BURNING_REWARD_RSP : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x42a;
        public static readonly uint CURRVERSION = 0x8a;
        public int iErrCode;
        public CSDT_BURNING_REWARD_DETAIL stRewardDetail = ((CSDT_BURNING_REWARD_DETAIL) ProtocolObjectPool.Get(CSDT_BURNING_REWARD_DETAIL.CLASS_ID));
        ...
        public override TdrError.ErrorType construct()
        {
            ...
            type = this.stRewardDetail.construct(iErrCode);
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            {
                long iErrCode = this.iErrCode;
                type = this.stRewardDetail.pack(iErrCode, ref destBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            {
                long iErrCode = this.iErrCode;
                type = this.stRewardDetail.unpack(iErrCode, ref srcBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }

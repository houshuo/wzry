namespace CSProtocol
{
    ...
    public class COMDT_SETTLE_HERO_RESULT_INFO : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x8e;
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                type = destBuf.writeUInt32(this.dwSettleProficiency);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                type = srcBuf.readUInt32(ref this.dwSettleProficiency);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }

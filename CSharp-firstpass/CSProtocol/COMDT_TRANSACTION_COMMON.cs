namespace CSProtocol
{
    ...
    public class COMDT_TRANSACTION_COMMON : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x179;
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            type = srcBuf.readUInt32(ref this.dwTransId);
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                type = srcBuf.readUInt32(ref this.dwTransSeq);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                type = srcBuf.readUInt8(ref this.bActionIndex);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }

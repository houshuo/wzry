namespace CSProtocol
{
    ...
    public class COMDT_RANKING_LIST_ITEM_EXTRA_PLAYER : ProtocolObject
    {
        ...
        public COMDT_TRANK_GRADEOFRANK_INFO stRankInfo = ((COMDT_TRANK_GRADEOFRANK_INFO) ProtocolObjectPool.Get(COMDT_TRANK_GRADEOFRANK_INFO.CLASS_ID));
        ...
        public static readonly uint VERSION_stRankInfo = 0x6b;
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                type = this.stRankInfo.construct();
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }

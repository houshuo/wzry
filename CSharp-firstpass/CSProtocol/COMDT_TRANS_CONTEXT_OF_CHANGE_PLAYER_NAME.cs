namespace CSProtocol
{
    ...
    public class COMDT_TRANS_CONTEXT_OF_CHANGE_PLAYER_NAME : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x175;
        public static readonly uint CURRVERSION = 1;
        public int iErrorCode;
        public static readonly uint LENGTH_szNewName = 0x40;
        public static readonly uint LENGTH_szOrgName = 0x40;
        public byte[] szNewName = new byte[0x40];
        public byte[] szOrgName = new byte[0x40];
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                if (dest > this.szOrgName.GetLength(0))
                {
                    if (dest > LENGTH_szOrgName)
                    {
                        return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
                    }
                    this.szOrgName = new byte[dest];
                }
                if (1 > dest)
                {
                    return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_SMALL;
                }
                type = srcBuf.readCString(ref this.szOrgName, (int) dest);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                if (this.szOrgName[((int) dest) - 1] != 0)
                {
                ...
                if (num3 > this.szNewName.GetLength(0))
                {
                    if (num3 > LENGTH_szNewName)
                    {
                        return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
                    }
                ...
                type = srcBuf.readCString(ref this.szNewName, (int) num3);
                if (type == TdrError.ErrorType.TDR_NO_ERROR)
                {
                    if (this.szNewName[((int) num3) - 1] != 0)
                    {
                        return TdrError.ErrorType.TDR_ERR_STR_LEN_CONFLICT;
                    }
                    ...
                    type = srcBuf.readUInt8(ref this.bNeedDelRegister);
                    if (type != TdrError.ErrorType.TDR_NO_ERROR)
                    {
                        return type;
                    }

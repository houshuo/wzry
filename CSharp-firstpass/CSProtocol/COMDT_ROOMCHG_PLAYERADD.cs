namespace CSProtocol
{
    ...
    public class COMDT_ROOMCHG_PLAYERADD : ProtocolObject
    {
        ...
        public int iCamp;
        public COMDT_ROOMMEMBER_DT stMemInfo = ((COMDT_ROOMMEMBER_DT) ProtocolObjectPool.Get(COMDT_ROOMMEMBER_DT.CLASS_ID));
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            type = destBuf.writeInt32(this.iCamp);
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            type = srcBuf.readInt32(ref this.iCamp);
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {

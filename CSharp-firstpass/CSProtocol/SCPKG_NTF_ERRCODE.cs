namespace CSProtocol
{
    ...
    public class SCPKG_NTF_ERRCODE : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x232;
        public static readonly uint CURRVERSION = 1;
        public int iErrCode;
        public SCDT_NTF_ERRCODE stErrDetail = ((SCDT_NTF_ERRCODE) ProtocolObjectPool.Get(SCDT_NTF_ERRCODE.CLASS_ID));
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                type = this.stErrDetail.pack(iErrCode, ref destBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            {
                long iErrCode = this.iErrCode;
                type = this.stErrDetail.unpack(iErrCode, ref srcBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }

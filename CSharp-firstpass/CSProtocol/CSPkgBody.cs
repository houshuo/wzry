namespace CSProtocol
{
    ...
    public class CSPkgBody : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x52f;
        ...
        public ProtocolObject select(long selector)
        {
            if (selector <= 0x438L)
            {
                this.select_1000_1080(selector);
            }
            else if (selector <= 0x477L)
            {
                this.select_1081_1143(selector);
            }
            else if (selector <= 0x4c1L)
            {
                this.select_1144_1217(selector);
            }
            else if (selector <= 0x57dL)
            {
                this.select_1218_1405(selector);
            }
            else if (selector <= 0x71fL)
            {
                this.select_1406_1823(selector);
            }
            else if (selector <= 0x8aeL)
            {
                this.select_1824_2222(selector);
            }
            else if (selector <= 0x8eaL)
            {
                this.select_2223_2282(selector);
            }
            else if (selector <= 0xb64L)
            {
                this.select_2283_2916(selector);
            }
            else if (selector <= 0x13edL)
            {
                this.select_2917_5101(selector);
            }
            else if (selector <= 0x1477L)
            {
                this.select_5102_5239(selector);
            }
        ...
        private void select_1000_1080(long selector)
        {
            long num = selector;
            if ((num >= 0x3e8L) && (num <= 0x438L))
            {
        ...
        private void select_1081_1143(long selector)
        {
            long num = selector;
            if ((num >= 0x439L) && (num <= 0x477L))
            {
                switch (((int) (num - 0x439L)))
                {
                    case 0:
        ...
        private void select_1144_1217(long selector)
        {
            long num = selector;
            if ((num >= 0x478L) && (num <= 0x4c1L))
            {
                switch (((int) (num - 0x478L)))
                {
                    case 0:
        ...
        private void select_1218_1405(long selector)
        {
            long num = selector;
            if ((num >= 0x4c2L) && (num <= 0x4efL))
            {
                switch (((int) (num - 0x4c2L)))
                {
                    case 0:
        ...
        private void select_1406_1823(long selector)
        {
            long num = selector;
            if ((num >= 0x57eL) && (num <= 0x5a2L))
            {
                switch (((int) (num - 0x57eL)))
                {
                    case 0:
            ...
            if ((num >= 0x708L) && (num <= 0x71fL))
            {
                switch (((int) (num - 0x708L)))
                {
                    case 0:
            ...
            if (num == 0x64eL)
            {
                if (!(this.dataObject is CSPKG_GETPVPLEVELREWARD_REQ))
                {
                    if (this.dataObject != null)
                    {
                        this.dataObject.Release();
            ...
            {
                if (!(this.dataObject is SCPKG_GETPVPLEVELREWARD_RSP))
                {
                    if (this.dataObject != null)
                    {
                        this.dataObject.Release();
        ...
        private void select_1824_2222(long selector)
        {
            long num = selector;
            if ((num >= 0x7daL) && (num <= 0x7f6L))
            {
            ...
            if ((num >= 0x899L) && (num <= 0x8aeL))
            {
                switch (((int) (num - 0x899L)))
                {
                    case 0:
            ...
            if ((num >= 0x720L) && (num <= 0x729L))
            {
                switch (((int) (num - 0x720L)))
                {
                    case 0:
        ...
        private void select_2223_2282(long selector)
        {
            long num = selector;
            if ((num >= 0x8afL) && (num <= 0x8eaL))
            {
                switch (((int) (num - 0x8afL)))
                {
                    case 0:
        ...
        private void select_2283_2916(long selector)
        {
            long num = selector;
            ...
            if ((num >= 0xaf0L) && (num <= 0xaf5L))
            {
                switch (((int) (num - 0xaf0L)))
                {
                    case 0:
            ...
            else if (!(this.dataObject is SCPKG_SET_GUILD_GROUP_OPENID_NTF))
            {
                if (this.dataObject != null)
                {
                    this.dataObject.Release();
        ...
        private void select_2917_5101(long selector)
        {
            long num = selector;
            if ((num >= 0x1004L) && (num <= 0x100eL))
            {
            ...
            {
                if (!(this.dataObject is SCPKG_JOIN_TVOIP_ROOM_NTF))
                {
                    if (this.dataObject != null)
                    {
                        this.dataObject.Release();
            ...
            {
                if (!(this.dataObject is CSPKG_ACNT_VOICESTATE))
                {
                    if (this.dataObject != null)
                    {
                        this.dataObject.Release();
            ...
            {
                if (!(this.dataObject is SCPKG_NTF_VOICESTATE))
                {
                    if (this.dataObject != null)
                    {
                        this.dataObject.Release();
        ...
        private void select_5102_5239(long selector)
        {
            long num = selector;
            if ((num >= 0x1451L) && (num <= 0x1477L))
            {
            ...
            if ((num >= 0x13eeL) && (num <= 0x13f7L))
            {
                switch (((int) (num - 0x13eeL)))
                {
                    case 0:

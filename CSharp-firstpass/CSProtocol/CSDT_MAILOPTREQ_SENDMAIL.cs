namespace CSProtocol
{
    ...
    public class CSDT_MAILOPTREQ_SENDMAIL : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x396;
        ...
        public static readonly uint VERSION_bSource = 0x12;
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                if (VERSION_bSource <= cutVer)
                {
                    type = destBuf.writeUInt8(this.bSource);
                    if (type != TdrError.ErrorType.TDR_NO_ERROR)
                    {
                        return type;
                    }
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                if (VERSION_bSource <= cutVer)
                {
                    type = srcBuf.readUInt8(ref this.bSource);
                    if (type != TdrError.ErrorType.TDR_NO_ERROR)
                    {
                        return type;
                    }

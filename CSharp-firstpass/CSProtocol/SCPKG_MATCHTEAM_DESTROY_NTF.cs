namespace CSProtocol
{
    ...
    public class SCPKG_MATCHTEAM_DESTROY_NTF : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x502;
        public static readonly uint CURRVERSION = 1;
        public COMDT_MATCHTEAM_DESTROY stDetail = ((COMDT_MATCHTEAM_DESTROY) ProtocolObjectPool.Get(COMDT_MATCHTEAM_DESTROY.CLASS_ID));

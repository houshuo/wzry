namespace CSProtocol
{
    ...
    public class COMDT_TRANSACTION_MSG_OF_WORLDREWARDLIMITRSP : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x18f;
        public static readonly uint CURRVERSION = 1;
        public int iResult;
        public COMDT_LIMITITEM_DATA stLimitItemData = ((COMDT_LIMITITEM_DATA) ProtocolObjectPool.Get(COMDT_LIMITITEM_DATA.CLASS_ID));
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            {
                type = this.stLimitItemData.pack(ref destBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                type = this.stLimitItemData.unpack(ref srcBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }

namespace CSProtocol
{
    ...
    public class COMDT_TEAMCHGNTF_INFO : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x121;
        public static readonly uint CURRVERSION = 0x5c;
        public int iChgType;
        public COMDT_TEAMCHG_DT stChgInfo = ((COMDT_TEAMCHG_DT) ProtocolObjectPool.Get(COMDT_TEAMCHG_DT.CLASS_ID));
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            type = destBuf.writeInt32(this.iChgType);
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                long iChgType = this.iChgType;
                type = this.stChgInfo.pack(iChgType, ref destBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }

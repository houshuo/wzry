namespace CSProtocol
{
    ...
    public class COMDT_CHAT_MSG_PRIVATE : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0xf1;
        ...
        public COMDT_CHAT_PLAYER_INFO stTo = ((COMDT_CHAT_PLAYER_INFO) ProtocolObjectPool.Get(COMDT_CHAT_PLAYER_INFO.CLASS_ID));
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            {
                type = this.stTo.pack(ref destBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                type = this.stTo.unpack(ref srcBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }

    ...
    public class COMDT_SYMBOLPAGE_DETAIL : ProtocolObject
    {
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                for (int i = 0; i < 30; i++)
                {
                    type = destBuf.writeUInt64(this.UniqueID[i]);
                    if (type != TdrError.ErrorType.TDR_NO_ERROR)
                    {
                        return type;
                    }
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                if (type == TdrError.ErrorType.TDR_NO_ERROR)
                {
                    ...
                    for (int i = 0; i < 30; i++)
                    {
                        type = srcBuf.readUInt64(ref this.UniqueID[i]);
                        if (type != TdrError.ErrorType.TDR_NO_ERROR)
                        {
                            return type;
                        }

namespace CSProtocol
{
    ...
    public class COMDT_APOLLO_PAY_PRESENTHERO : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x1ab;
        public static readonly uint CURRVERSION = 1;
        public uint dwHeroID;
        public COMDT_ACNT_UNIQ stFriendUniq = ((COMDT_ACNT_UNIQ) ProtocolObjectPool.Get(COMDT_ACNT_UNIQ.CLASS_ID));
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            type = this.stFriendUniq.pack(ref destBuf, cutVer);
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            type = this.stFriendUniq.unpack(ref srcBuf, cutVer);
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {

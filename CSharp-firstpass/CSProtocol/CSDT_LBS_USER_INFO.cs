namespace CSProtocol
{
    ...
    public class CSDT_LBS_USER_INFO : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x35b;
        public static readonly uint CURRVERSION = 0x63;
        public uint dwDistance;
        public uint dwGameSvrEntity;
        public COMDT_FRIEND_INFO stLbsUserInfo = ((COMDT_FRIEND_INFO) ProtocolObjectPool.Get(COMDT_FRIEND_INFO.CLASS_ID));
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            type = this.stLbsUserInfo.pack(ref destBuf, cutVer);
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                type = destBuf.writeUInt32(this.dwDistance);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            type = this.stLbsUserInfo.unpack(ref srcBuf, cutVer);
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                type = srcBuf.readUInt32(ref this.dwDistance);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }

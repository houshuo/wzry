namespace CSProtocol
{
    ...
    public class COMDT_TEAMMEMBER_INFO : ProtocolObject
    {
        ...
        public COMDT_TEAMMEMBER_DETAIL stMemberDetail = ((COMDT_TEAMMEMBER_DETAIL) ProtocolObjectPool.Get(COMDT_TEAMMEMBER_DETAIL.CLASS_ID));
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            type = destBuf.writeUInt32(this.dwPosOfTeam);
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            type = srcBuf.readUInt32(ref this.dwPosOfTeam);
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {

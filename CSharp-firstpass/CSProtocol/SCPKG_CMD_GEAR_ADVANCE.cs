namespace CSProtocol
{
    ...
    public class SCPKG_CMD_GEAR_ADVANCE : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x332;
        public static readonly uint CURRVERSION = 1;
        public uint dwHeroID;
        public COMDT_HERO_WEARINFO stWearInfo = ((COMDT_HERO_WEARINFO) ProtocolObjectPool.Get(COMDT_HERO_WEARINFO.CLASS_ID));
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                type = this.stWearInfo.pack(ref destBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                type = this.stWearInfo.unpack(ref srcBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }

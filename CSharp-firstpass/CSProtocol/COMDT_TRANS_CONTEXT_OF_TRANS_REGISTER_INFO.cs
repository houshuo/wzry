namespace CSProtocol
{
    ...
    public class COMDT_TRANS_CONTEXT_OF_TRANS_REGISTER_INFO : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x169;
        public static readonly uint CURRVERSION = 1;
        public uint dwAcntSeq;
        public int iDbVersion;
        public static readonly uint LENGTH_szOpenID = 0x40;
        public static readonly uint LENGTH_szRegisterName = 0x40;
        public byte[] szOpenID = new byte[0x40];
        public byte[] szRegisterName = new byte[0x40];
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                type = destBuf.writeUInt8(this.bFailKickAcnt);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                if (type == TdrError.ErrorType.TDR_NO_ERROR)
                {
                    ...
                    type = srcBuf.readUInt8(ref this.bFailKickAcnt);
                    if (type != TdrError.ErrorType.TDR_NO_ERROR)
                    {
                        return type;
                    }

namespace CSProtocol
{
    ...
    public class CSPKG_SEND_GUILD_MAIL_REQ : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x523;
        public static readonly uint CURRVERSION = 1;
        public static readonly uint LENGTH_szContent = 600;
        public static readonly uint LENGTH_szSubject = 0x80;
        public byte[] szContent = new byte[600];
        public byte[] szSubject = new byte[0x80];
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                if (dest > this.szSubject.GetLength(0))
                {
                    if (dest > LENGTH_szSubject)
                    {
                        return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
                    }
                    this.szSubject = new byte[dest];
                }
                if (1 > dest)
                {
                    return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_SMALL;
                }
                type = srcBuf.readCString(ref this.szSubject, (int) dest);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                if (this.szSubject[((int) dest) - 1] != 0)
                {
                ...
                if (num3 > this.szContent.GetLength(0))
                {
                ...
                type = srcBuf.readCString(ref this.szContent, (int) num3);
                if (type == TdrError.ErrorType.TDR_NO_ERROR)
                {
                    if (this.szContent[((int) num3) - 1] != 0)
                    {
                        return TdrError.ErrorType.TDR_ERR_STR_LEN_CONFLICT;
                    }

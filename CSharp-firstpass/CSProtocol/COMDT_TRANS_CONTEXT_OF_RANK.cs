namespace CSProtocol
{
    ...
    public class COMDT_TRANS_CONTEXT_OF_RANK : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x14e;
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                type = srcBuf.readUInt32(ref this.dwOldClass);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                type = srcBuf.readUInt8(ref this.bNewGrade);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                type = srcBuf.readUInt32(ref this.dwNewClass);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }

namespace CSProtocol
{
    ...
    public class COMDT_TRANS_CONTEXT_OF_JOIN_GUILD : ProtocolObject
    {
        ...
        public static readonly int CLASS_ID = 0x151;
        public static readonly uint CURRVERSION = 0x84;
        public static readonly uint LENGTH_szGuildName = 0x20;
        public COMDT_GUILD_MEMBER_BRIEF_INFO stApplyPlayer = ((COMDT_GUILD_MEMBER_BRIEF_INFO) ProtocolObjectPool.Get(COMDT_GUILD_MEMBER_BRIEF_INFO.CLASS_ID));
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            type = this.stApplyPlayer.pack(ref destBuf, cutVer);
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            type = this.stApplyPlayer.unpack(ref srcBuf, cutVer);
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {

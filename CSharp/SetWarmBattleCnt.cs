...
[ArgumentDescription(0, typeof(byte), "地图人数", new object[] {  }), ArgumentDescription(1, typeof(uint), "比赛场数", new object[] {  }), CheatCommand("关卡/温暖局/SetWarmBattleCnt", "设置温暖局地图比赛场数", 0x3b)]

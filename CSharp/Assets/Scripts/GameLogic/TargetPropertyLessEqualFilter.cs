namespace Assets.Scripts.GameLogic
{
    ...
    public struct TargetPropertyLessEqualFilter
    {
        ...
        public TargetPropertyLessEqualFilter(List<ActorRoot> _list, ulong _maxValue = 18446744073709551615L)
        {
            this.targetList = _list;
            this.maxValue = _maxValue;
        }

        public void Initial(List<ActorRoot> _list, ulong _maxValue = 18446744073709551615L)
        {
            this.targetList = _list;
            this.maxValue = _maxValue;
        }

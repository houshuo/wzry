namespace Assets.Scripts.GameLogic
{
    ...
    public class CTreasureHud
    {
        ...
        public void Clear()
        {
            ...
            this.label = null;
            this.Num = null;
            Singleton<EventRouter>.instance.RemoveEventHandler(EventID.DropTreasure, new System.Action(this.onGetTreasure));
        }
        ...
        public void Init(GameObject obj)
        {
            ...
            Singleton<EventRouter>.instance.AddEventHandler(EventID.DropTreasure, new System.Action(this.onGetTreasure));

namespace Assets.Scripts.GameLogic
{
    ...
    public class SkillSelectMyDirection : SkillBaseSelectTarget
    {
        ...
        {
            return Singleton<TargetSearcher>.GetInstance().GetNearestEnemy((ActorRoot) UseSlot.Actor, UseSlot.SkillObj.cfgData.iMaxSearchDistance, TargetPriority.TargetPriority_Hero, UseSlot.SkillObj.cfgData.dwSkillTargetFilter, true);
        }

namespace Assets.Scripts.GameSystem
{
    ...
    public class CStarEvalPanel
    {
        ...
        private void DeinitEvent()
        {
            ...
            Singleton<EventRouter>.instance.RemoveEventHandler(EventID.StarSystemInitialized, new System.Action(this.reset));
        ...
        private void initEvent()
        {
            ...
            Singleton<EventRouter>.instance.AddEventHandler(EventID.StarSystemInitialized, new System.Action(this.reset));

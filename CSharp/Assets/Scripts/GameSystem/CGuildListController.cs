namespace Assets.Scripts.GameSystem
{
    ...
    internal class CGuildListController : Singleton<CGuildListController>
    {
        ...
        public override void Init()
        {
            ...
            Singleton<EventRouter>.GetInstance().AddEventHandler("Request_PrepareGuild_Info", new System.Action(this.OnRequestPrepareGuldInfo));
            ...
            Singleton<EventRouter>.GetInstance().AddEventHandler("Receive_PrepareGuild_Info_Failed", new System.Action(this.OnRequestPrepareGuldInfoFailed));
            ...
            Singleton<EventRouter>.GetInstance().AddEventHandler("Receive_PrepareGuild_Create_Failed", new System.Action(this.OnReceivePrepareGuildCreateFailed));

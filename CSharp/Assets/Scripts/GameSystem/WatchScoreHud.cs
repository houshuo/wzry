namespace Assets.Scripts.GameSystem
{
    ...
    public class WatchScoreHud
    {
        ...
        public WatchScoreHud(GameObject root)
        {
            ...
            Singleton<EventRouter>.instance.AddEventHandler(EventID.BATTLE_TOWER_DESTROY_CHANGED, new System.Action(this.OnCampTowerChange));
            Singleton<EventRouter>.instance.AddEventHandler(EventID.BATTLE_DRAGON_KILL_CHANGED, new System.Action(this.OnCampDragonChange));
        ...
        public void Clear()
        {
            ...
            Singleton<EventRouter>.instance.RemoveEventHandler(EventID.BATTLE_TOWER_DESTROY_CHANGED, new System.Action(this.OnCampTowerChange));
            Singleton<EventRouter>.instance.RemoveEventHandler(EventID.BATTLE_DRAGON_KILL_CHANGED, new System.Action(this.OnCampDragonChange));
        }
        ...
        {
            this._campMoneyText_1.text = string.Format("{0:N1}k", campMoney_1 * 0.001f);
            this._campMoneyText_2.text = string.Format("{0:N1}k", campMoney_2 * 0.001f);
        }
    }
}

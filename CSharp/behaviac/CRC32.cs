namespace behaviac
{
    ...
    {
        private static uint[] s_table = new uint[] { 
        ...
        public static uint CalcCRC(string str)
        {
            ...
            for (int i = 0; i < str.Length; i++)
            {
                char ch = str[i];
                byte b = (byte) ch;
                UpdateB(ref maxValue, b);
            }
            UpdateB(ref maxValue, (byte) str.Length);
            return maxValue;
        }

        private static void UpdateB(ref uint crc, byte b)
        {

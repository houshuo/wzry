...
[CheatCommand("通用/排行榜/SetMasterHero", "设置大神排行榜", 0x4b), ArgumentDescription(1, typeof(uint), "英雄ID", new object[] {  }), ArgumentDescription(2, typeof(uint), "胜场数", new object[] {  }), ArgumentDescription(3, typeof(uint), "总场数", new object[] {  }), ArgumentDescription(ArgumentDescriptionAttribute.EDefaultValueTag.Tag, 4, typeof(ulong), "UID", "0", new object[] {  }), ArgumentDescription(ArgumentDescriptionAttribute.EDefaultValueTag.Tag, 5, typeof(int), "逻辑区", "0", new object[] {  })]
